...
if ($method == 'POST') {
    ...
    if (isset($params['id_platforms_user']) && isset($params['id_platforms']) && isset($params['email'])) {
        $id_platforms_user = $params['id_platforms_user'];
        $id_platforms = $params['id_platforms'];
        $email = $params['email'];

        // Fetch email from platforms_users
        $sql = "SELECT email FROM platforms_users WHERE id_platforms_user = ? AND id_platforms = ?";
        ...
        try {
            ...
            // Content
            $mail->isHTML(true);
            $mail->Subject = $session_code.' es tu código de verificación de PadelRoom';
                            ...
                            >
                              <tr>
                                <td class="pad">
                                  ...
                                  >
                                    Tu codigo:
                                    <span style="font-size: 45px">'.$session_code.'</span>
                                  </h1>
                                </td>
                              </tr>
                            </table>
                            ...
                            >
                              <tr>
                                <td class="pad">
                                  ...
                                  >
                                    <p style="margin: 0">
                                      Ingresa el codigo anterior para continuar
                                      con tu inicio de sesión
                                    </p>
                                  </div>
                                </td>
                              </tr>
