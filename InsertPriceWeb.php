...
if ($method == 'POST') {
    ...
    if (isset($params['id_platforms']) && isset($params['price']) && isset($params['platforms_fields_price_start_time']) && isset($params['platforms_fields_price_end_time']) && isset($params['active'])) {
        ...
        $stmt->bind_param("idssi", $id_platforms, $price, $platforms_fields_price_start_time, $platforms_fields_price_end_time, $active);
